...
#SBATCH --output=/home/ak308/Bio310/output/ak308_fstscan_window_KANK2.out 
#SBATCH --error=/home/ak308/Bio310/output/ak308_fstscan_window_KANK2.err
...
--out ${OUT}/KANK2_filtered_fst_results_2.5kbwindow_1kbstep

## Make the dog population files 
# touch /scratch/ak308/Bio310_Dog/Files/KANK2_woollydogs.txt
# copy and paste the names of the dogs in the VCF file that have woolly coats
# touch /scratch/ak308/Bio310_Dog/Files/KANK2_nonwoollydogs.txt
# copy and paste the names of the dogs in the VCf file that do not have woolly coats
