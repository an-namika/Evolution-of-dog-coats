...
OUTBED=/scratch/ak308/Bio310_Dog/Results/KANK2_bed
OUTPLINK=/scratch/ak308/Bio310_Dog/Results/KANK2_plink
OUTVCF_final=/scratch/ak308/Bio310_Dog/Results/KANK2_plink_finalcoded
...
sed -i 's:0/0:0:g' KANK2_plink_finalcoded.vcf
sed -i 's:0/1:1:g' KANK2_plink_finalcoded.vcf
sed -i 's:1/0:1:g' KANK2_plink_finalcoded.vcf
sed -i 's:1/1:2:g' KANK2_plink_finalcoded.vcf
sed -i 's:./.:3:g' KANK2_plink_finalcoded.vcf


### Move to local computer 
### make sure you SIGN OUT of NOTS first!!! -- by typing "exit" in terminal

scp -r ak308@nots.rice.edu:/scratch/ak308/Bio310_Dog/Results/KANK2_plink_finalcoded.vcf ~/Desktop
