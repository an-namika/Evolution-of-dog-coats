...
OUT=/scratch/ak308/Bio310_Dog/Results/IGF1_vcf_ancientcanids

vcftools --gzvcf ${VCF} --chr chr15 --from-bp 41223737 --to-bp 41223737 --recode --recode-INFO-all --out ${OUT}
