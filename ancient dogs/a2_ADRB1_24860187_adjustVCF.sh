...
VCF=/scratch/ak308/Bio310_Dog/Results/ADRB124860187_vcf_ancientcanids.recode.vcf
OUTBED=/scratch/ak308/Bio310_Dog/Results/ADRB124860187_vcf_ancientcanids_bed
OUTPLINK=/scratch/ak308/Bio310_Dog/Results/ADRB124860187_vcf_ancientcanids_plink
OUTVCF_FINAL=/scratch/ak308/Bio310_Dog/Results/ADRB124860187_vcf_ancientcanids_finalcoded
...
sed -i 's:0/0:0:g' ADRB124860187_vcf_ancientcanids_finalcoded.vcf
sed -i 's:0/1:1:g' ADRB124860187_vcf_ancientcanids_finalcoded.vcf
sed -i 's:1/0:1:g' ADRB124860187_vcf_ancientcanids_finalcoded.vcf
