## =========================
## 6) ADRB1 24870184 MODERN
## =========================

## Before R: 

- Open the "modernADRB1_24870184_vcf_ancientcanids_finalcoded.vcf" as a text edit file
...
ggsave("ADRB1_24870184_gene_modern.tiff", width=10, height=3)
