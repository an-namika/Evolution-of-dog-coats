## =========================
## 4) ADRB1 24860187 MODERN
## =========================

## Before R: 

- Open the "modernADRB1_24860187_vcf_ancientcanids_finalcoded.vcf" as a text edit file
...
#Choose the modern variant 

### Open the vcf file on your computer and save it as a csv file: 

dat_hap <- read.csv("modernADRB1_24860187_vcf_ancientcanids_finalcoded.csv", header=TRUE)
...
ggsave("ADRB1_24860187_gene_modern.tiff", width=10, height=3)
