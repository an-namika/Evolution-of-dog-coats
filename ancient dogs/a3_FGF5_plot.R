...
- Open the "FGF5_vcf_ancientcanids_finalcoded.vcf" as a text edit file
...
dat_hap <- read.csv("FGF5_vcf_ancientcanids_finalcoded.csv", header=TRUE)
...
#Plot with geom_tile entire gene
...
ggsave("FGF5_gene_ancient.tiff", width=10, height=3)
