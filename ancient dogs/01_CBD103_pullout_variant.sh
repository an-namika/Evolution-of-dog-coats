...
OUT=/scratch/ak308/Bio310_Dog/Results/CBD103_vcf_ancientcanids

vcftools --gzvcf ${VCF} --chr chr16 --from-bp 53650174 --to-bp 53650174 --recode --recode-INFO-all --out ${OUT}
