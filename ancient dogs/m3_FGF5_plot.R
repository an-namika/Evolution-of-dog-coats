...
- Open the "modernFGF5_vcf_ancientcanids_finalcoded.vcf" as a text edit file
...
dat_hap <- read.csv("modernFGF5_vcf_ancientcanids_finalcoded.csv", header=TRUE)
...
ggsave("FGF5_gene_modern.tiff", width=10, height=3)
