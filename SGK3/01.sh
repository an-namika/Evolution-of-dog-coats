...
OUT=/scratch/ak308/Bio310_Dog/Results/SGK3_vcf_ancientcanids

vcftools --gzvcf ${VCF} --chr chr29 --from-bp 16366701 --to-bp 16366701 --recode --recode-INFO-all --out ${OUT}
